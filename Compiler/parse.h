...
TOKEN makefor(int sign, TOKEN tok, TOKEN i, TOKEN tokb, TOKEN endexpr,
...
TOKEN instenum(TOKEN lparen, TOKEN idlist, TOKEN rparen);
...
/* Convert nil into a number tok with value 0 */
